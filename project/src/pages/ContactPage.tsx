...
import { Mail, Phone, MapPin, Calendar, Clock, Send, Users, CheckCircle } from 'lucide-react';
              ...
              <div className="space-y-6 mb-12">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-700">
                      <a href="mailto:Brickmaster@gmail.com" className="hover:text-primary-600 transition-colors">
                        Brickmaster@gmail.com
                      </a>
                      <br />
